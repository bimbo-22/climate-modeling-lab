...
* Variables we should check – global:  – 2m Temperature above ground (2D) –  – incoming SW radiation ground (2D) –  – total cloud cover (2D) – 
* Variables we should check – vertical profile (zonal mean):  – temperature profile (2D) –  – zonal wind (3D) – For the Jetstream 
